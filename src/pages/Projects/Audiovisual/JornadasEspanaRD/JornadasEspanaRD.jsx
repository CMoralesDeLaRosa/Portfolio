...
const jornadasEspanaRDItems = {
  ...
  imgMain:
    'https://res.cloudinary.com/dmztjnlrp/image/upload/v1746728692/Porfolio/Semanas%20de%20Espa%C3%B1a%20en%20RD/Semanas-Espa%C3%B1a-RD-Main-Image.png',
  ...
  return (
    <section id='section-semanas-espana-project' className='flex-container'>
      ...
      <article className='article-papaoutai-focus'>
        ...
        <p>{jornadasEspanaRDItems.focus3}</p>
      </article>
